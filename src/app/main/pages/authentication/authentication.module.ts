...
import { ActivateUserV2Component } from 'app/main/pages/authentication/activate-user-v2/auth-activate-user-v2.component';
...
const routes: Routes = [
  ...
  { 
    path: 'authentication/activate-user-v2',
    component: ActivateUserV2Component
